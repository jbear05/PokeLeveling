...
# Load tile images
grass_tile = pygame.transform.scale(pygame.image.load(create_path('Assets/Tiles/grass.png')), (TILE_SIZE, TILE_SIZE))
water_tile = pygame.transform.scale(pygame.image.load(create_path('Assets/Tiles/water.png')), (TILE_SIZE, TILE_SIZE))
fire_tile = pygame.transform.scale(pygame.image.load(create_path('Assets/Tiles/fire.png')), (TILE_SIZE, TILE_SIZE))
desert_tile = pygame.transform.scale(pygame.image.load(create_path('Assets/Tiles/sand.png')), (TILE_SIZE, TILE_SIZE))
snow_tile = pygame.transform.scale(pygame.image.load(create_path('Assets/Tiles/snow.png')), (TILE_SIZE, TILE_SIZE))
factory_tile = pygame.transform.scale(pygame.image.load(create_path('Assets/Tiles/factory.png')), (TILE_SIZE, TILE_SIZE))
graveyard_tile = pygame.transform.scale(pygame.image.load(create_path('Assets/Tiles/graveyard.png')), (TILE_SIZE, TILE_SIZE))
forest_tile = pygame.transform.scale(pygame.image.load(create_path('Assets/Tiles/forest.png')), (TILE_SIZE, TILE_SIZE))
dojo_tile = pygame.transform.scale(pygame.image.load(create_path('Assets/Tiles/dojo.png')), (TILE_SIZE, TILE_SIZE))
clouds_tile = pygame.transform.scale(pygame.image.load(create_path('Assets/Tiles/clouds.png')), (TILE_SIZE, TILE_SIZE))
swamp_tile = pygame.transform.scale(pygame.image.load(create_path('Assets/Tiles/swamp.png')), (TILE_SIZE, TILE_SIZE))
dragons_den_tile = pygame.transform.scale(pygame.image.load(create_path('Assets/Tiles/dragons_den.png')), (TILE_SIZE, TILE_SIZE))
...
background_image = pygame.image.load(create_path('Assets/Background/background.png'))
background_image = pygame.transform.scale(background_image, (SCREEN_WIDTH, SCREEN_HEIGHT))

#Load item menu image
item_menu = pygame.image.load(create_path('Assets/Background/item_menu.png'))
item_menu = pygame.transform.scale(item_menu, (SCREEN_WIDTH, SCREEN_HEIGHT))

#load pc image
pc_menu = pygame.image.load(create_path('Assets/Background/pc_menu.png'))
...
starter_menu = pygame.image.load(create_path('Assets/Background/starter_menu.png'))
...
while running:
    ...
    if inventory_open:
        ...
        if keys[pygame.K_a]:
            if direction == "left":
                dx = -1
                player.image = [pygame.image.load(create_path(f'Assets\\Player\\player_walking_left{i}.png')) for i in range(1, 5)]
                moving = True
            else:
                player.image = [pygame.image.load(create_path(f'Assets\\Player\\player_walking_left1.png'))]
                direction = "left"
        elif keys[pygame.K_d]:
            if direction == "right":
                dx = 1
                player.image = [pygame.image.load(create_path(f'Assets\\Player\\player_walking_right{i}.png')) for i in range(1, 5)]
                moving = True
            else:
                player.image = [pygame.image.load(create_path(f'Assets\\Player\\player_walking_right1.png'))]
                direction = "right"
        ...
        # Vertical movement (up or down)
            ...
            if direction == "up":
                dy = -1
                player.image = [pygame.image.load(create_path(f'Assets\\Player\\player_walking_up{i}.png')) for i in range(1, 5)]
                moving = True
            else:
                player.image = [pygame.image.load(create_path(f'Assets\\Player\\player_walking_up1.png'))]
                direction = "up"
        elif keys[pygame.K_s]:
            if direction == "down":
                dy = 1
                player.image = [pygame.image.load(create_path(f'Assets\\Player\\player_walking_down{i}.png')) for i in range(1, 5)]
                moving = True
            else:
                player.image = [pygame.image.load(create_path(f'Assets\\Player\\player_walking_down1.png'))]
                direction = "down"
        else:
            moving = False
            player.frame = 0
